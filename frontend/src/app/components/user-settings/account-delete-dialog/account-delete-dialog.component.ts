	...
	public reasonsList = [
		{
			...
			message:
				'Perhaps Rocketadmin has updated the functions you need and they are in a different place. ' +
		...
		},
		{
			...
			message:
				'If you have technical problems, please contact our <strong>Support team</strong> and we will solve your problem.',
		},
		{
			id: 'another-product',
			caption: 'Another product',
			message:
				'If you are interested in another product, you can read <a href="https://help.rocketadmin.com/comparisons-with-other-database-admin-tools">the article</a> where they are compared.',
		},
		{
			id: 'privacy-concern',
