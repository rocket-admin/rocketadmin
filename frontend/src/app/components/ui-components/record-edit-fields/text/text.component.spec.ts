...
describe('TextEditComponent', () => {
	...
	it('should set maxLength from structure character_maximum_length', () => {
		fixture.componentRef.setInput('structure', { character_maximum_length: 255 } as any);
		component.ngOnInit();
	...
	it('should parse validateType from widget params string', () => {
		fixture.componentRef.setInput('widgetStructure', { widget_params: JSON.stringify({ validate: 'isURL' }) } as any);
		component.ngOnInit();
