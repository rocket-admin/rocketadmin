...
describe('MarkdownDisplayComponent', () => {
	...
	describe('Title extraction', () => {
		...
		it('should extract title from markdown with lists', () => {
			fixture.componentRef.setInput('value', '# Shopping List\n\n- Item 1\n- Item 2');
			component.ngOnInit();
