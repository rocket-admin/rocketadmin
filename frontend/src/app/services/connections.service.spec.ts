...
describe('ConnectionsService', () => {
  ...
  it('should get visible tabs dashboard, audit and users if groupsAccessLevel is true', () => {
    service.groupsAccessLevel = true;
    expect(service.visibleTabs).toEqual(['dashboard', 'audit', 'users']);
  })
  ...
  it('should call createConnection and show Success Snackbar', () => {
    ...
    service.createConnection(connectionCredsApp).subscribe(res => {
      expect(res).toEqual(connectionCredsNetwork);
      expect(fakeNotifications.showSuccessSnackbar).toHaveBeenCalledOnceWith('Connection was added successfully.');
      isSubscribeCalled = true;
    });
  ...
  it('should call updateConnection and show Success Snackbar', () => {
    ...
    service.updateConnection(connectionCredsApp).subscribe(res => {
      expect(fakeNotifications.showSuccessSnackbar).toHaveBeenCalledOnceWith('Connection has been updated successfully.');
      isSubscribeCalled = true;
    });
  ...
  it('should call getConnectionSettings', () => {
    let isSubscribeCalled = false;
