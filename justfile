...
# other database engines (Oracle, MSSQL, Mongo, Cassandra, Redis,
...
test args='test/ava-tests/non-saas-tests/!(*oracle*|*cassandra*|*elasticsearch*|*mssql*|*mongo*|*redis*|*dynamodb*|*clickhouse*).test.ts':
