...
export const Messages = {
  ...
  LOGIN_DENIED: 'Incorrect email or password. Maybe you signed up through third-party authentication?',
  ...
  GOOGLE_LOGIN_FAILED:
    'Google account login failed. If the problem persists, please contact our support team.',
