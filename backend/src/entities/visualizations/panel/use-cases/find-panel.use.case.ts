...
import { IFindPanel } from './panel-use-cases.interface.js';

@Injectable({ scope: Scope.REQUEST })
export class FindSavedDbQueryUseCase extends AbstractUseCase<FindSavedDbQueryDs, FoundPanelDto> implements IFindPanel {
	constructor(
	...
	public async implementation(inputData: FindSavedDbQueryDs): Promise<FoundPanelDto> {
		...
		return buildFoundPanelDto(foundQuery);
	}
}
