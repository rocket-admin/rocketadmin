...
export function mapSchemaChangeToResponseDto(entity: TableSchemaChangeEntity): SchemaChangeResponseDto {
	return {
		...
		aiAutoFixApplied: entity.aiAutoFixApplied,
		aiAutoFixOriginalForwardSql: entity.aiAutoFixOriginalForwardSql,
		aiAutoFixOriginalRollbackSql: entity.aiAutoFixOriginalRollbackSql,
		aiAutoFixOriginalError: entity.aiAutoFixOriginalError,
