...
export class ConnectionEntity {
	...
	@OneToMany(
		(_) => TableLogsEntity,
		(logs) => logs.connection_id,
	)
	logs: Relation<TableLogsEntity>[];

	@OneToMany(
		(_) => ActionRulesEntity,
		(action_rules) => action_rules.connection,
	)
	...
	@OneToOne(
		(_) => ConnectionPropertiesEntity,
		(connection_properties) => connection_properties.connection,
	)
	...
	@OneToMany(
		(_) => TableFiltersEntity,
		(table_filters) => table_filters.connection,
	)
	...
	dashboards: Relation<DashboardEntity>[];
}
