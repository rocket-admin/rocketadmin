...
export class AddedExternalProviderRegistrationPropertyInUserEntity1702029067334 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_externalregistrationprovider_enum" AS ENUM('GOOGLE', 'GITHUB')`);
        await queryRunner.query(`ALTER TABLE "user" ADD "externalRegistrationProvider" "public"."user_externalregistrationprovider_enum"`);
    }
