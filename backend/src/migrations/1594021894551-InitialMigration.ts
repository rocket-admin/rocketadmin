...
export class InitialMigration1594021894551 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "group" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "connectionId" uuid, CONSTRAINT "UQ_c5dcbf6b8ecf068f959a367dc9e" UNIQUE ("connectionId", "title"), CONSTRAINT "PK_256aa0fda9b1de1a73ee0b7106b" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`CREATE TABLE "user" ("id" uuid NOT NULL, "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "permission_groups_group" ("permissionId" uuid NOT NULL, "groupId" uuid NOT NULL, CONSTRAINT "PK_6fa192288ad79f889c117f7edc1" PRIMARY KEY ("permissionId", "groupId"))`,
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_0dd43db7f5e646262978c3ad0a" ON "permission_groups_group" ("permissionId") `,
		);
		...
		await queryRunner.query(
			`ALTER TABLE "permission_groups_group" ADD CONSTRAINT "FK_0dd43db7f5e646262978c3ad0aa" FOREIGN KEY ("permissionId") REFERENCES "permission"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "permission_groups_group" ADD CONSTRAINT "FK_b78f7697f5b985fc4f40615aaf9" FOREIGN KEY ("groupId") REFERENCES "group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "user_groups_group" ADD CONSTRAINT "FK_8abdfe8f9d78a4f5e821dbf6203" FOREIGN KEY ("groupId") REFERENCES "group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
	}
