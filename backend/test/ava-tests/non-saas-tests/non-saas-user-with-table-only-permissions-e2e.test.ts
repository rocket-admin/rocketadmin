...
const _newConnectionToPostgres = mockFactory.generateConnectionToTestPostgresDBInDocker();
...
test.serial(
	...
	async (t) => {
		try {
			...
			const _connectionPropertiesResult = JSON.parse(createConnectionPropertiesResponse.text);
