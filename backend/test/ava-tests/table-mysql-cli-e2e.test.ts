...
test(`${currentTest} should throw an exception when primary key passed in request has incorrect field value`, async (t) => {
  ...
  t.is(deleteRowInTableRO.message, 'Failed to delete row from table. It seems like something went wrong while processing your query. Please try again later or contact our support team.');
});
